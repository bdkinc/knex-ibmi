...
declare module 'knex/lib/schema/tablecompiler'
{
    ...
    class TableCompiler
    {
        ...
        check(checkPredicate : string, bindings : any[], constraintName : string) : void;
        _addChecks() : string;
...
declare module 'knex/lib/schema/columncompiler'
{
    ...
    {
        constructor(client : Knex.Client, tableCompiler ?: TableCompiler, columnBuilder ?: Knex.ColumnBuilder);
        ...
        checkLength(operator : string, length : number, constraintName : string) : string;
    }
...
declare module 'knex/lib/schema/compiler'
{
    ...
    class SchemaCompiler
    {
        ...
        pushQuery(query : string | { sql : string, bindings : any, output : any }) : void;
        pushAdditional(fn : any) : void;
        unshiftQuery(query : string | { sql : string, bindings : any }) : void;
    }
